...
namespace FrostedGlass
{
    ...
    namespace Maps
    {
        ...
        static const std::unordered_map<wstring, Types::EFFECT> EffectMap =
        {
            ...
            {L"3", Types::EFFECT::BOTH},          {L"both", Types::EFFECT::BOTH},                {L"combined", Types::EFFECT::BOTH}
        };
    ...
    namespace API
    {
        ...
        using PSET_COMPOSITION = void(__stdcall*)(HWND hHwnd, CompositionAttribute* Data);
        using PSET_ATTRIBUTE = void(__stdcall*)(HWND Hwnd, INT Attribute, LPCVOID Data, INT Size);
        ...
        class InstanceState
        {
            ...
            static void LoadUser32() noexcept;
            static void UnloadUser32() noexcept;
            static void LoadDwmapi() noexcept;
            static void UnloadDwmapi() noexcept;

            public:
            static PSET_COMPOSITION SetWindowCompositionAttribute;
            static PSET_ATTRIBUTE SetWindowAttribute;
        ...
        {
        public:
            static wstring ToWstring(const uint8_t _Value) noexcept;
            static void ToLowerCase(wstring& _Input) noexcept;
            static void ToRemoveSpace(wstring& _Input) noexcept;
            static bool Evaluate(wstring& _Input, const wstring& _Search) noexcept;
        };
        
        class ColorHelper
        {
        private:
            static uint8_t ClampColor(const int _Value) noexcept;
            static bool IsValidHexColor(wstring& _Color) noexcept;
            static bool IsValidDecColor(wstring& _Color) noexcept;

        public:
            static wstring GetColor(Measure* _Measure, wstring& _Color) noexcept;
            static uint32_t SetColor(wstring& _Color) noexcept;
        };
